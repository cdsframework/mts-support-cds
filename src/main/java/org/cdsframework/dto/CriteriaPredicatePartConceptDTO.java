 ...
 */
@Entity
@Table(databaseId = "CDS", name = "criteria_predicate_part_concept")
@JndiReference(root = "mts-ejb-cds")
@Permission(name = "Criteria Predicate Part Concept", isListed = false)
public class CriteriaPredicatePartConceptDTO extends BasePredicatePartConceptDTO {

    private static final long serialVersionUID = 8417009184657093781L;
