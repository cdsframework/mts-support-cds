 ...
 */
@Entity
@Table(databaseId = "CDS", name = "criteria_version_rel")
@JndiReference(root = "mts-ejb-cds")
@Permission(name = "Criteria Version Relationship", isListed = false)
public class CriteriaVersionRelDTO extends BaseDTO {
    private static final long serialVersionUID = 512255221167549178L;
