...
public enum CodedElementType {
    ...
    public static CodedElementType valueOfLabel(String label) {
        CodedElementType result = null;
        for (CodedElementType item : CodedElementType.values()) {
