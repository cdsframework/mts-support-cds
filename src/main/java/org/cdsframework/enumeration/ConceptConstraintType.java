 ...
 */
public enum ConceptConstraintType {
    Code,
    CodeSystem,
    Concept,
    List,
    ...
    public static ConceptConstraintType valueOfLabel(String label) {
        ConceptConstraintType result = null;
        for (ConceptConstraintType item : ConceptConstraintType.values()) {
