...
public enum CriteriaMethod {
    SYMPTOM("Symptom"),
    DIAGNOSIS("Diagnosis"),
    CONTRIBUTING_TO_DEATH("Contributing to Death"),
    CONTACT("Contact"),
    ...
    private CriteriaMethod(String label) {
        this.label = label;
    }
    ...
    public static CriteriaMethod valueOfLabel(String label) {
        CriteriaMethod result = null;
        for (CriteriaMethod item : CriteriaMethod.values()) {
