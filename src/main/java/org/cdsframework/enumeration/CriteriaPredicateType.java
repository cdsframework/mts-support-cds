 ...
 */
public enum CriteriaPredicateType {
    PredicateGroup,
    Predicate,
    Criteria;
    ...
    public static CriteriaPredicateType valueOfLabel(String label) {
        CriteriaPredicateType result = null;
        for (CriteriaPredicateType item : CriteriaPredicateType.values()) {
