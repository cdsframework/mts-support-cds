...
public enum DataModelNodeType {
    ...
    public static DataModelNodeType valueOfLabel(String label) {
        DataModelNodeType result = null;
        for (DataModelNodeType item : DataModelNodeType.values()) {
