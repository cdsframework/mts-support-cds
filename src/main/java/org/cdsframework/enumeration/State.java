...
public enum State {
    ...
    WYOMING("Wyoming", "WY"),
    DISNEY_WORLD ("Disney World", "DW"),
    LAND_OF_OOO ("Land of Ooo", "LO"),
    LEGO_LAND ("Lego Land", "LL"),
    PIZZA_PLANET ("Pizza Planet", "PP"),
    MAGIC_KINGDOM ("Magic Kingdom", "MK"),
    DANDY_DESTINATION ("Dandy Destination", "DD"),
