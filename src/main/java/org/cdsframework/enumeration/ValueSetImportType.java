...
public enum ValueSetImportType {
    PHINVADS("PHIN VADS"),
    VSAC("VSAC");
    
    private final String label;

    private ValueSetImportType(String label) {
        this.label = label;
    }
    ...
    public static ValueSetImportType valueOfLabel(String label) {
        ValueSetImportType result = null;
        for (ValueSetImportType item : ValueSetImportType.values()) {
