...
public enum ValueSetType {
    ...
    private ValueSetType(String label) {
        this.label = label;
    }
    ...
    public static ValueSetType valueOfLabel(String label) {
        ValueSetType result = null;
        for (ValueSetType item : ValueSetType.values()) {
