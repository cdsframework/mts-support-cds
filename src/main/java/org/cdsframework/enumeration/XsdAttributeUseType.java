 ...
 */
public enum XsdAttributeUseType {
    Optional,
    Prohibited,
    Required;
    ...
    public static XsdAttributeUseType valueOfLabel(String label) {
        XsdAttributeUseType result = null;
        for (XsdAttributeUseType item : XsdAttributeUseType.values()) {
