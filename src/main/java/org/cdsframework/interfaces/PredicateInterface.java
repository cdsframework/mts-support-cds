...
public interface PredicateInterface {
    ...
    public List<? extends BasePredicateDTO> getPredicateDTOs();

    public List<? extends BasePredicatePartDTO> getPredicatePartDTOs();

    public List<? extends BasePredicatePartDTO> getGroupPredicatePartDTOs();
