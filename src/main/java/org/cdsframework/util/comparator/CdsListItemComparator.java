 ...
 */
public class CdsListItemComparator implements Comparator<CdsListItemDTO> {

    @Override
    public int compare(CdsListItemDTO t0, CdsListItemDTO t1) {
        if (t0 == null && t1 == null) {
            return 0;
        }
        if (t0 == null && t1 != null) {
        ...
        if (t0.getName() == null && t1.getName() == null) {
            return 0;
        }
        if (t0.getName() == null && t1.getName() != null) {
            return -1;
