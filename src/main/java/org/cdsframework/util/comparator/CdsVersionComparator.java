 ...
 */
public class CdsVersionComparator implements Comparator<CdsVersionDTO> {

    @Override
    public int compare(CdsVersionDTO o1, CdsVersionDTO o2) {
        if (o1 == null && o2 == null) {
            return 0;
        }
        if (o1 == null && o2 != null) {
        ...
        String v1 = o1.getVersion().replaceAll("[^\\d.]", "");
        String v2 = o2.getVersion().replaceAll("[^\\d.]", "");
