 ...
 */
public class ConceptDeterminationMethodComparator implements Comparator<ConceptDeterminationMethodDTO> {

    @Override
    public int compare(ConceptDeterminationMethodDTO o1, ConceptDeterminationMethodDTO o2) {
        if (o1 == null && o2 == null) {
            return 0;
        }
        if (o1 == null && o2 != null) {
