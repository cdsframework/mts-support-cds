 ...
 */
public class CriteriaDataTemplateRelNodeComparator implements Comparator<CriteriaDataTemplateRelNodeDTO> {

    @Override
    public int compare(CriteriaDataTemplateRelNodeDTO o1, CriteriaDataTemplateRelNodeDTO o2) {
        if (o1 == null && o2 == null) {
            return 0;
        }
        if (o1 == null && o2 != null) {
        ...
        if (o1.getNodePath()== null && o2.getNodePath() == null) {
            return 0;
        }
        if (o1.getNodePath() == null && o2.getNodePath() != null) {
            return -1;
