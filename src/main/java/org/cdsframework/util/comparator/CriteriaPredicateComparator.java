 ...
 */
public class CriteriaPredicateComparator implements Comparator<PredicateInterface> {

    @Override
    public int compare(PredicateInterface o1, PredicateInterface o2) {
        if (o1 == null && o2 == null) {
            return 0;
        }
        if (o1 == null && o2 != null) {
        ...
        return Integer.compare(o1.getPredicateOrder(), o2.getPredicateOrder());
    }
