 ...
 */
public class CriteriaPredicatePartComparator implements Comparator<PredicatePartInterface> {

    @Override
    public int compare(PredicatePartInterface o1, PredicatePartInterface o2) {
        if (o1 == null && o2 == null) {
            return 0;
        }
        if (o1 == null && o2 != null) {
        ...
        return Integer.compare(o1.getPredicatePartOrder(), o2.getPredicatePartOrder());
    }
