 ...
 */
public class DataModelClassNodeComparator implements Comparator<DataModelClassNodeDTO> {
    
    @Override
    public int compare(DataModelClassNodeDTO o1, DataModelClassNodeDTO o2) {
        if (o1 == null && o2 == null) {
            return 0;
        }
        if (o1 == null && o2 != null) {
